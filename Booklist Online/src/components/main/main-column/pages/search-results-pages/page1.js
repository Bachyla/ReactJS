  ...
  return (
    <Fragment>
      ...
      <div className="search-results-wrapper">
        <a
          className="oer-span-a font-size-10 margin-bottom-5 margin-top-12"
          href="/"
          target="_blank"
        >
          <b>
        ...
        <div className="search-results-nav">
          ...
          <Link className="prev-page-button" to="/search-results/">
            Previous Page
          </Link>
          <Link className="nav-button" to="/search-results/">
            <u>1</u>
          </Link>
          <Link className="nav-button selected" to="/page1/">
            2
          </Link>
          <Link className="next-page-button" to="/page1/">
            <u>Next Page</u>
          </Link>
      ...
      <SearchResultBlock
        ...
        date={"January 1, 2016"}
        text={
          "Nov. 2015. 176p. Top Shelf, hardcover, $24.99 (9781603093750). 741.5."
        }
        image={bookImage}
        imageWidth={25}
        imageHeight={25}
      ...
      <SearchResultBlock
        ...
        text={
          "Jan. 2019. 336p. Farrar/Sarah Crichton, $27 (9780374107895). 323."
        }
        image={ebookImage}
        imageWidth={17}
        imageHeight={26}
      ...
      <SearchResultBlock
        ...
        date={"July, 2015"}
        text={
          "June 2015. 244p. Thomas Nelson, hardcover, $24.99 (9780718021764). 820.9."
        }
        image={bookImage}
        imageWidth={25}
        imageHeight={25}
      ...
      <SearchResultBlock
        ...
        text={
          "Aug. 2018. 32p. illus. Cherry Lake, paper, $14.21 (9781534132849); Cherry Lake, lib. ed., $29.93 (9781534129641). Grades 4-7. 796.334. "
        }
        image={bookImage}
        imageWidth={25}
        imageHeight={25}
      ...
      <SearchResultBlock
        title={
          "Becoming Mrs. Lewis: The Improbably Love Story of Joy Davidman and C. S. Lewis. "
        }
      ...
      <SearchResultBlock
        title={
          "Two Flags over Iwo Jima: Solving the Mystery of the U. S. Marine’s Corps’ Proudest Moment. "
        }
        links={[
          "Adult Books - ",
          "Nonfiction - ",
        ...
        date={"October 1, 2018"}
        text={
          "Oct. 2018. 222p. illus. Casemate, $29.95 (9781612006291). 940.54. "
        }
        image={bookImage}
        imageWidth={25}
        imageHeight={25}
      ...
      <SearchResultBlock
        title={
          "The Fellowship: The Literary Lives of the Inklings; J. R. R. Tolkien and C. S. Lewis. "
        }
        links={[
          "Adult Books - ",
          "Nonfiction - ",
      ...
      <SearchResultBlock
        ...
        date={"June 1, 2015"}
        text={
          "Jan. 2015. 64p. illus. Compass Point, paperback, $8.95 (9780756549985); Compass Point, library edition, $33.99 (9780756549923). Grades 4-7. 973.04. "
        }
        image={starImage}
        imageWidth={17}
        imageHeight={17}
