    ...
    render() {
        ...
        return(
            <div className="wrapper">
                <Link to="/search-reviews/"><img className="tabs" src={srActive === true ? SearchReviewOn : SearchReviewOff} alt="SR" width="94" height="36"/></Link>
                <Link to="/search-features/"><img className="tabs" src={sfActive === true ? SearchFeaturesOn : SearchFeaturesOff} alt="SF" width="94" height="36"/></Link>
                <Link to="/saved-searches/"><img className="tabs" src={ssActive === true ? SavedSearchesOn : SavedSearchesOff} alt="SS" width="94" height="36"/></Link>
            </div>
        )
    }
}
